...
function useControlled(_ref) {
  ...
  var _React$useRef = React16.useRef(controlled !== void 0), isControlled = _React$useRef.current;
  var _React$useState = React16.useState(defaultProp), valueState = _React$useState[0], setValue = _React$useState[1];
  ...
  if (true) {
    ...
    var _React$useRef2 = React16.useRef(defaultProp), defaultValue = _React$useRef2.current;
    React16.useEffect(function() {
  ...
  var setValueIfUncontrolled = React16.useCallback(function(newValue) {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-XUTUIOC5.js.map
